                  ...
                  <TableCell>
                    {row.coverImage ? (
                      ...
                      <img
                        src={row.coverImage}
                        alt=""
                        className="h-12 w-12 rounded-[14px] object-cover bg-admin-surface-low"
                      />
                    ) : (
              ...
              <div className="flex items-start gap-3">
                {row.coverImage ? (
                  ...
                  <img
                    src={row.coverImage}
                    alt=""
                    className="h-12 w-12 shrink-0 rounded-[14px] bg-admin-surface-low object-cover"
                  />
                ) : (
                ...
                <span className="text-xs text-admin-on-surface-variant tabular-nums shrink-0">
                  {row.productCount} тов.
                </span>
              </div>
