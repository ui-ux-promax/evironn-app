...
import { createHeroCardContainerVariants, createHeroCardItemVariants } from './hero-product-motion';
import { HeroProductCaption } from './hero-product-caption';
...
export function HeroProductCard({ product, visible, locked, reducedMotion, onBack }: HeroProductCardProps) {
