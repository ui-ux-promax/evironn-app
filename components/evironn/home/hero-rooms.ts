...
import type { AvailableHeroRoomId, HeroRoomId } from './hero-room-state';
...
export const HERO_ROOMS: Record<AvailableHeroRoomId, HeroRoom> = {
  ...
  kitchen: {
    id: 'kitchen',
    label: 'КУХНЯ',
    idleSrc: '/assets/hero/kitchen-idle.webp',
  ...
  bedroom: {
    id: 'bedroom',
    label: 'СПАЛЬНЯ',
    idleSrc: '/assets/hero/bedroom-idle.webp',
  ...
  terrace: {
    id: 'terrace',
    label: 'ТЕРРАСА',
    idleSrc: '/assets/hero/terrace-idle.webp',
