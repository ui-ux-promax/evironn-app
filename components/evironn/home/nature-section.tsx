...
export function NatureSection() {
  return (
    <section className="nature-section" aria-labelledby="nature-heading-primary">
          ...
          <div className="nature-content">
            <div className="nature-intro">
              <div className="nature-heading" aria-label={natureHeading}>
                <NatureHeading className="nature-heading-primary" firstOrder={0} text="Материалы," />
                <NatureHeading className="nature-heading-secondary" firstOrder={12} text="которые стареют красиво" />
              </div>
              <p className="nature-copy">
                Материалы задают ритм комнате: дерево добавляет тепло, ткань — мягкость, а выверенные пропорции
                оставляют пространство для жизни.
              </p>
            </div>
