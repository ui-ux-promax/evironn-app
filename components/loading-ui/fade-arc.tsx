...
// Loading UI Fade Arc (MIT): https://loading-ui.com/r/fade-arc.json
// Animation lives in a stylesheet to preserve the application's CSP.
import { useId, type ComponentProps } from 'react';
import styles from './fade-arc.module.css';

export function FadeArc({ className, ...props }: ComponentProps<'svg'>) {
