...
type RawSearchParams = URLSearchParams | Record<string, string | string[] | undefined> | undefined;

const readParam = (searchParams: RawSearchParams, key: string): string | undefined => {
...
export const buildPaginationMeta = (input: Pick<PaginationInput, 'page' | 'limit'>, total: number): PaginationMeta => ({
  page: input.page,
  limit: input.limit,
  total,
