...
export function productDenormFromColorways(colorways: DenormColorway[]): { minPrice: number; discountPct: number } {
  const cw = [...colorways].sort((a, b) => Number(b.isDefault) - Number(a.isDefault) || a.sortOrder - b.sortOrder)[0];
