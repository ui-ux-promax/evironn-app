export const siteName = 'Evironn';
export const defaultSeoTitle = 'Evironn — мебель для спокойных интерьеров';
...
export const defaultOgImage = '/assets/products/03-ivory-lounge-cutout.webp';
...
export function buildBreadcrumbListJsonLd(items: Array<{ name: string; url: string }>, base = getSiteUrl()) {
  return {
    '@context': 'https://schema.org',
    '@type': 'BreadcrumbList',
