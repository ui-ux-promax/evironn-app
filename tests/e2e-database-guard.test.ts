...
describe('resolveE2eDatabaseEnvironment', () => {
  ...
  it('accepts pooled and direct Neon-style hostnames for one normalized identity', () => {
    ...
    ).toMatchObject({ POSTGRES_URL: pooled, POSTGRES_URL_NON_POOLING: direct, RESEND_API_KEY: '' });
  });
